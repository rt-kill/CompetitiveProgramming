...
void solve() {
    ...
    // we make a segment tree with lazy propigation
    //  each node will store the sum of all nodes it contains
    //  lazy will either store some operation (x, y) that has yet to be applied to the range, or
    //      some value V that the nodes must sum to
    //
}
