...
void solve() {
    ...
    vvi opt_assignment(11, vi(k+1, INT_MIN/4)); // opt_assignment[b][k] is the optimal value that can be achevied with values from bucket b that sum to k
    ...
    ve<vvi> dp(11, vvi(k+1, vi(2, INT_MIN/4)));
    dp[0][0][0] = 0, dp[0][0][1] = 0;

    for(int b=1; b<=10; ++b) {
        dp[b][0][0] = 0, dp[b][0][1] = 0;
